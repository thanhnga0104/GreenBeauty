...
const SettingAccount =({navigation})=>
{
    ...
    const UpdateData = async () =>{
        await fetch ('http://10.0.2.2:8000/user/'+ data.id+'/',
        {
            ...
            body: JSON.stringify({"email": data.email, "name": data.name, "phone": data.phonenum, "sex": data.sex, "dateofbirth": data.birthday})
    ...
    const UploadImage = async (val)=>
    {
        ...
        fetch(
            'http://10.0.2.2:8000/user/'+ data.id + '/',
            {
              body: form,
              method: "PUT",
              headers: {
            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <View style={styles.containeravt}>
                        <Avatar.Image style={{backgroundColor:"#FFF"}} size={scale(widthofscreen/6.5)} source={{uri : data.avt}}/>
                ...
                <View style={{alignItems:"center", justifyContent:"center", marginBottom:scale(5), marginTop:scale(15)}}>
                <TouchableOpacity style={styles.buttoncontainer}
                    onPress={()=> {Update()}}>
                    <Text style={{fontSize: scale(17), fontWeight: '300', color:"#FFF"}}
