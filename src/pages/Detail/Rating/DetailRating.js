    ...
    return(
            <View style={{flex:1}}>
                <View style={{flexDirection:"row",justifyContent:"space-evenly", marginBottom:10}}>
                    <TouchableOpacity style={{marginTop: scale(15), marginLeft: scale(15), }}
                    onPress={()=>{
                        getData(0);
                        HandleChangeClick(0)}}>
                    ...
                    <TouchableOpacity style={{marginTop: scale(15), marginLeft: scale(15),}}
                    onPress={()=>{getData(1); HandleChangeClick(1);}}>
                    ...
                    <TouchableOpacity style={{marginTop: scale(15), marginLeft: scale(15),}}
                    onPress={()=>{getData(2); HandleChangeClick(2);}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"space-evenly"}}>
                    ...
                    onPress={()=>{getData(3); HandleChangeClick(3);}}>
                    ...
                    onPress={()=>{getData(4); HandleChangeClick(4);}}>
                    ...
                    <TouchableOpacity style={{marginLeft: scale(10)}}
                    onPress={()=>{getData(5); HandleChangeClick(5);}}>
                ...
                data={renderData}
                renderItem={({item})=>{
                  return(<RatingComponent point = {item.ratingpoint}
                  id = {item.user} comment ={item.ratingcomment} img = {"http://127.0.0.1:8000" + item.img}/>)
                }}
