...
const Rating = (props) =>
{
    ...
    const UploadRating = async ()=>
    {
        ...
        fetch(
            'http://10.0.2.2:8000/product/'+  props.id + '/add-rating/',
            {
              body: form,
              method: "POST",
              headers: {
    ...
    return(
    <View style={{justifyContent:"space-between",backgroundColor:"white", marginTop: 5}}>
        <BottomSheet
              ref={bs}
              snapPoints={[400, 0]}
            ...
            <View style={{flexDirection:"column", marginTop: 5}}>
                <Text style={{ marginTop: 10}} ellipsizeMode="tail"
